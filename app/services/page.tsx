...
export default function ServicesPage() {
  return <InnerShell>
    ...
    <section className="inner-process"><p>How we work</p><h2>Clarity at every stage.</h2><ol>{processSteps.map((step, index) => <li key={step.title}><span>{String(index + 1).padStart(2, '0')}</span>{step.title}</li>)}</ol></section>
  </InnerShell>;
}
