  ...
  return (
    <InnerShell>
      <section className="relative flex min-h-[70svh] items-end overflow-hidden">
        ...
        <div className="relative z-[1] w-full px-(--spacing-gutter) pb-12 pt-32 text-brand-white">
      ...
      <section className="px-(--spacing-gutter) py-(--spacing-section)">
        ...
        <h2 className="font-heading text-4xl">One Team Held The Line From Intent To Execution.</h2>
        <div className="mt-8 flex flex-wrap gap-3">
          {['Clear decisions', 'Coordinated delivery', 'Quality-led finishing', 'Accountable handover'].map((item) => (
      ...
      >
        <span>
          <span className="block text-[13px] tracking-[0.12em] text-brand-red uppercase">Next Case Study</span>
